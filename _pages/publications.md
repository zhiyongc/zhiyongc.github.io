...
1.	**Cui Z**, Lin L, Pu Z, Wang Y\*. (2020) Graph Markov Network for Traffic Forecasting with Missing Data. *Transportation Research Part C: Emerging Technologies* (under review) (<span style="color: blue;">ASA TSIG Student Paper Award</span>) \[[arXiv](https://arxiv.org/abs/1912.05457)\]
1.	**Cui Z**, Ke R, Pu Z, Wang Y\*. (2020) Stacked Bidirectional and Unidirectional LSTM Recurrent Neural Network for Forecasting Network-wide Traffic State with Missing Values. *Transportation Research Part C: Emerging Technologies* (under review) 
